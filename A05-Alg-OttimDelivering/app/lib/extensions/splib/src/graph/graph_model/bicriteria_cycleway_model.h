...
template <
  ...
  typename WeightT>
class bicriteria_cycleway_model : 
...
template <
  ...
  typename RestrictionMap, 
  typename WeightT>
WeightT bicriteria_cycleway_model<
    GraphT, 
    VertexMap, 
    RestrictionMap,
    WeightT
...
template <
  ...
  typename RestrictionMap, 
  typename WeightT>
void bicriteria_cycleway_model<
    GraphT, 
    VertexMap, 
    RestrictionMap,
    WeightT
    ...
    features_map& fmap)  
{
  ...
  { 
    ...
    if (!(fmap.count(feature_Kt::highway_is_cycleway_oneway) && 
          boost::any_cast<bool>(fmap[feature_Kt::highway_is_cycleway_oneway]))) 
    {  
