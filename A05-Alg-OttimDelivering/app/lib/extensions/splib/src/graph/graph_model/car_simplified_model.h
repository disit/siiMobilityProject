#ifndef GOL_GRAPH_CAR_MODEL_H_
#define GOL_GRAPH_CAR_MODEL_H_
...
{  
  ...
  if ( (fmap.count(feature_Kt::highway_is_pedestrian) && 
        !(boost::any_cast<bool>(fmap[feature_Kt::highway_is_pedestrian])))  
     )  
  { 
    typename Traits::edge_descriptor e; bool inserted;
    
    if ( (fmap.count(feature_Kt::highway_is_oneway) && 
         !(boost::any_cast<bool>(fmap[feature_Kt::highway_is_oneway])))
       ||
         (fmap.count(feature_Kt::highway_is_oneway_forward) && 
         (boost::any_cast<bool>(fmap[feature_Kt::highway_is_oneway_forward])))
       ) 
    {
