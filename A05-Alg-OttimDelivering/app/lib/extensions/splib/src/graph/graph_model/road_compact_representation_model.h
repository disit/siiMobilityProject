...
#ifndef GOL_GRAPH_REALCAR_MODEL_H_
#define GOL_GRAPH_REALCAR_MODEL_H_
...
template <
  ...
  typename WeightT>
class road_compact_representation_model : 
...
template <
  ...
  typename Constraints,
  typename WeightT>
WeightT road_compact_representation_model<
    GraphT, 
    VertexMap,
    EdgeMap,
    Constraints, 
...
template <
  ...
  typename Constraints,
  typename WeightT>
void road_compact_representation_model<
    GraphT, 
    VertexMap,
    EdgeMap,
    Constraints, 
...
{  
  ...
  if (fmap.is_road_highway())  
  { 
    typename Traits::edge_descriptor e; bool inserted;
    
    if ( fmap.is_not_oneway_highway() ||
         fmap.is_forward_oneway_highway() ) 
    {
      ...
      if (!inserted) {
        ...
        (Base::_edgmap)[Base::_edge_index] = e; 
        (Base::_g)[e].edge_index = Base::_edge_index;       
        ++Base::_edge_index;
    ...
    if ( fmap.is_not_oneway_highway() ||
         fmap.is_reverse_oneway_highway() ) 
    {    
...
#endif // GOL_GRAPH_REALCAR_MODEL_H_	
